...
/*$('#search-btn').click(function(){
	if ($('#search-input').val() == "") {
		alert('검색어를 입력해주세요.');
		location.href = "/greenpaw/manager_board.do";
	}
});*/
...
function viewPost(seq) {
	...
	switch (categoryNum) {
		case 0:
			url = '/greenpaw/manager_board.do';
			break;
		case 1:
			url = '/greenpaw/normal_board_view.do?category=1&seq=' + seq + '&page=1';
			break;
		case 2:
			url = '/greenpaw/personal_album_view.do?cpage=1&seq=' + seq;
			break;
		case 3:
			url = '/greenpaw/community_album_view.do?cpage=1&seq=' + seq;
			break;
		case 4:
			url = '/greenpaw/review_view.do?cpage=1&seq=' + seq;
			break;
		case 5:
			url = '/greenpaw/thumb_view.do?cpage=1&seq=' + seq;
			break;
		case 6:
			url = '/greenpaw/normal_board_view.do?category=6&seq=' + seq + '&page=1';
			break;
		case 7:
			url = '/greenpaw/normal_board_view.do?category=7&seq=' + seq ;
			break;
	}
	location.href = url;
}