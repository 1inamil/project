<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	String mail = (String) session.getAttribute("kakao_email");
	String nickname = (String) session.getAttribute("kakao_nickname"); 
    
	System.out.println("kakao_nickname.jsp => nickname 확인창");
  ...
  <body>
    <div class="main">
      ...
      <div class="right">
        ...
        <form class="join_us_form" action="/greenpaw/kakao_sign_up.do" method="post" name="jfrm">
