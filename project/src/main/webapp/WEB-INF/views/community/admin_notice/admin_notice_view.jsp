...
<body>
	<main>
      ...
      <div class="go-link">
        <ul class="link-menu">
          <li><a href="./admin_noticeboard.do?category=${param.category }&page=${param.page}">-List</a></li>
          <li><a href="./admin_notice_modify.do?category=${param.category }&page=${param.page}&seq=${param.seq }">-Modify</a></li>
	...
	<script type="text/javascript" src="./js/delete_notice_view.js"></script>
</body>
</html>