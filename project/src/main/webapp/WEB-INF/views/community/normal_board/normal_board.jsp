...
<%
	...
	for(BoardTO to : result){
		...
		sbHtml.append("		<a href='./normal_board_view.do?category="+category+"&seq="+seq+"&page="+cPage+"' class='title-item'>"+title+"</a>");
		sbHtml.append("		</div>");
		sbHtml.append("	</div>");
		...
		<div class="main">
			...
			<div class="main-body">
				...
				<div class="main-body-banner">
					<div class="banner" style="cursor:pointer;" onclick="location.href='./normal_board.do?category=${param.category}'"></div>
				</div>
				<!-- 검색창 -->
				<div class="search_wrap">
					<form action="./normal_board.do" method="get" class="searchform">
				...
				<div class="inner_content">
					<div class="filter_wrap">
						<div>
							<a class="search_filter" href="./normal_board.do?category=${param.category }&field=${param.field }&keyword=${param.keyword}&sort=seq">최근 순</a>
							<!-- <span></span> -->
							<a class="search_filter" href="./normal_board.do?category=${param.category }&field=${param.field }&keyword=${param.keyword}&sort=hit">인기 순</a>
						
							<a class="search_filter" href="./normal_board.do?category=${param.category }&field=type&keyword=pet">동물</a>
							<!-- <span></span> -->
							<a class="search_filter" href="./normal_board.do?category=${param.category }&field=type&keyword=plant">식물</a>
						</div>
					</div>
					<!------ 리스트 -------->
					<div class="list_wrap">
						...
						if(session.getAttribute("mail") != null){
								if(category != null && !category.equals("7")){
									out.println("<a type='button' href='./subTitle_write.do?category="+category+"' id='write-btn'>글쓰기</a>");
