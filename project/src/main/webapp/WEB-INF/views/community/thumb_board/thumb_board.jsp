    ...
    <div class="main-body">
        ...
        <div class="inner_content">
                <div class="filter_wrap">
               		<div>
                		<a class="search_filter" href="./thumbnail_board.do?categorySeq=${param.categorySeq}&field=${param.field}&keyword=${param.keyword}&sort=seq">최근 순</a>

                		<a class="search_filter" href="./thumbnail_board.do?categorySeq=${param.categorySeq}&field=${param.field}&keyword=${param.keyword}&sort=hit">조회 순</a>
                		
                		<a class="search_filter" href="./thumbnail_board.do?categorySeq=${param.categorySeq}&field=type&keyword=pet">동물</a>
						
						<a class="search_filter" href="./thumbnail_board.do?categorySeq=${param.categorySeq}&field=type&keyword=plant">식물</a>
                	</div>
                </div>
                <div class="list_wrap">
                    <!------ 리스트 -------->
                    ...
                    <a type="button" href="./thumb_write.do?categorySeq=<%=categorySeq %>" id="write-btn">글쓰기</a>
                <!--페이지-->
