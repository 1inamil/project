 	 ...
 	 <%@ include file="../../nav_bar.jsp" %>
        ...
        <div class="album_right">
          ...
          <%if(nickname != null && nickname.equals(sessionNickname)){%>
            <li class="menu_list">
              <a href="./thumb_modify.do?cpage=<%=cpage%>&seq=<%=seq %>&type=<%=familyMemberType%>" id="edit">edit</a>
            </li>
            <li class="menu_list">
            ...
            <% }%>
            <li class="list">
              <a href="./thumbnail_board.do?categorySeq=<%=categorySeq%>&type=<%=familyMemberType%>&cpage=<%=cpage%>">list</a>
            </li>
          </ul>
        </div>
      </div>
