...
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
    ...
    <%
		...
		if(flag == 1){ //비로그인 시
			...
			out.println("location.href='/greenpaw/main.do';");
			out.println("</script>");
		}
    ...
    <div class="main">
     <!-- nav bar include -->
      ...
      <div class="right">
        ...
        <form class="log_in_form" action="<%=contextPath %>/login_ok.do" method="post">
          <p>Email</p>
          ...
          <p class ="fp"><a href='<%=contextPath %>/forgot_password.do'>Forgot Password?</a></p>
        </form>
       <!-- 카카오 정보를 담을 것 추가한 부분 -->
        <form action="<%=contextPath %>/kakao_check.do" method="post" name="kakaofrm">
       ...
       <div class="divider"><span>Join Us</span></div>
        <div class="join">
          <a href="<%= contextPath %>/join_us.do" id="createAccount">Create Account</a>
          <span>or</span>
          <!-- 이걸 클릭하면 카카오 시작-수정함 -->
