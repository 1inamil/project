...
<%@page import="com.project.greenpaw.albumboard.AlbumDAO"%>
...
<%
	...
	for(int i = 0; i<lists.size(); i++){
	    ...
	    sbHtml.append("<a href='./personal_album_view.do?cpage="+cpage+"&seq="+seq+"&type="+type+"'>");
...
<%
	       		...
	       		if(startBlock == 1){
	       			...
	       			out.println("<span class='forward'><a href='./personal_album_list.do?cpage="
	       		...
	       		for(int i = startBlock; i <= endBlock; i++){
	       			if(cpage == i){
		       			...
		       			out.println("<span class='numbers'><a href='./personal_album_list.do?cpage="+i+"&type="+type+"'>"
	       						+ i +"</a></span>");   				
	       			};
	       		};
	       		...
	       		if(endBlock == totalPages){
	       			...
	       			out.println("<span class='backward'><a href='./personal_album_list.do?cpage="
	       						+ (startBlock + blockPerPage)+"&type="+type+"'>&gt;&gt;</a></span>");       			
	       		};
...
%>
        ...
        <div class="album_right">
          <ul class="menu">
            <li class="menu_list">
              <a href="./personal_album_list.do" id="all">all</a>
            </li>
            <li class="menu_list">
              <a href="./personal_album_list.do?type=plant" id="plantList">plant</a>
            </li>
            <li class="menu_list">
              <a href="./personal_album_list.do?type=pet" id="petList">pet</a>
            </li>
            <li class="new">
              <a href="./personal_album_write.do?cpage=<%=cpage %>">new</a>
            </li>
          </ul>
        </div>
      </div>
